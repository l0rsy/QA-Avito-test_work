...
**Ожидаемый результат:**
Страница должна загружаться корректно. Так же, как и при нажатии кнопки **"Статистика"** на главной странице
...
## Описание проблемы
**Краткое описание:** 
Сайт не работает на мобильных девайсах Iphone

**Шаги воспроизведения:**
1. Запустить сайт с Iphone 12 Pro (указать его в конфиге при тестировании)\
```--project=mobile-phone```

**Фактический результат:**
Ошибка\
![](./images/bugs_images/mobile_homePage_bug.jpg)
...
| **Приоритет** | Средний |
| **Окружение** | Браузер: Chrome 123.0, OS: Windows 10 |
| **Тест-кейс** | TC-DESK-01 |
| **Статус** | Open |

## Описание проблемы
**Краткое описание:** 
Отображается объявление с ценой больше, чем указано в поле "До"

**Шаги воспроизведения:**
1. Ввести в поле **"До"** 95450.3

**Фактический результат:**
Отображается объявление с ценой 97141

**Ожидаемый результат:**
Все объявления должны быть с ценами до 95450.3

## Логи / Консоль

TC-DESK-01
```bash
Error: Цена объявления 2 (97141) не в диапазоне 78095.7-95450.3

expect(received).toBeLessThanOrEqual(expected)

Expected: <= 95450.3
Received:    97141
at HomePage.assertAllPricesAreInRangeFromFirstItem (D:\Code\QA-Avito-test_work\pages\homePage\homePage.ts:266:18)
at D:\Code\QA-Avito-test_work\tests\desktop\TC-DESK-01.ts:22:9
```
